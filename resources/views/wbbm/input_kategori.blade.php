                    ...
                    <div class="card-body">
                      <form action="{{ route('categories-store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name', 'categories') is-invalid @enderror">
                      ...
                      <form action="{{ route('subcategories-store') }}" method="POST">
                            ...
                            <div class="form-group">
                              <label>Tambah Point Kategori</label>
                                <input type="text" name="name" class="form-control @error('name', 'subcategories') is-invalid @enderror">
                                {{-- @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                              <select class="form-control  @error('categories_id', 'subcategories') is-invalid @enderror" name="categories_id" id="">
                      ...
                      <form action="{{ route('items-store') }}" method="POST">
                            ...
                            <div class="form-group">
                              <label>Tambah Item Point Kategori</label>
                                <input type="text" name="name" class="form-control @error('name', 'items') is-invalid @enderror">
                                {{-- @error('name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                              <label>Jumlah Dokumen Wajib (Masukkan angka)</label>
                                <input type="number" name="required_document" class="form-control @error('required_document', 'items') is-invalid @enderror">
                            ...
                            <div class="form-group">
                              <select class="form-control  @error('sub_categories_id', 'items') is-invalid @enderror" name="sub_categories_id" id="">
                      ...
                      <form action="{{ route('documentItem-store') }}" method="POST">
                            ...
                            <div class="form-group">
                              <label>Tambah Nama Dokumen Item</label>
                                <input type="text" name="document_name" class="form-control @error('document_name', 'itemdocuments') is-invalid @enderror">
                                @error('document_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                              <select class="form-control  @error('item_id', 'itemdocuments') is-invalid @enderror" name="item_id" id="">
